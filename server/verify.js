  ...
  var GREY_RATIO = 1, QUERY_KEY = "aq-nc-grey-ratio", STABLE_ACTION = function() {
    ...
    !function(e) {
      ...
      function i(e, t, n) {
        if (e) {
          var i = 0, o = e.length;
          if (o === +o) for (; i < o && t.call(n, e[i], i, e) !== !1; i++) ; else for (i in e) if (e.hasOwnProperty(i) && t.call(n, e[i], i, e) === !1) break;
        }
      }
      ...
      var d = window, u = document, p = n(2), _ = t.rndId = function(e) {
      ...
      t.each = i, t.hasClass = o, t.addClass = a, t.removeClass = r, t.toggleClass = function(e, t) {
        ...
        var n = Math.floor((new Date).getTime() / (36e5 * (t || 2))), i = e.indexOf("?") === -1 ? "?" : "&";
        return e + i + "_t=" + n;
      };
      var f = {};
      t.isIEX = function(e) {
      ...
      t.getClientRect = function(e) {
        ...
        var i = s(e), o = l(e);
        return { left: i, right: i + e.offsetWidth, top: o, bottom: o + e.offsetHeight };
      }, t.getOffset = function(e) {
        var t = e.target;
        void 0 === t.offsetLeft && (t = t.parentNode);
        var n = g(t), i = { x: d.pageXOffset + e.clientX, y: d.pageYOffset + e.clientY };
        return { offsetX: i.x - n.x, offsetY: i.y - n.y };
      };
      ...
      t.decorator = h, t.mix = function(e) {
        ...
        var n = [].slice, i = n.call(arguments, 2), o = function() {
        }, a = function() {
        ...
        var t = p.defer(), n = e.data || {}, i = ("jsonp_" + Math.random()).replace(".", "");
        d[i] = function(e) {
          t.resolve(e);
      ...
      i.prototype = {
        constructor: i, then: function(e, t) {
          var n = new i, a = o(n, e, "resolve"), r = o(n, t, "reject");
      ...
      function i(e) {
        var t = ("_nc_r_" + Math.random()).replace(/\./, ""), n = a[t] = new Image;
        n.onload = n.onerror = function() {
          a[t] = null;
        }, n.src = e;
      }

      var o = (n(4).URL_MAP, "//cf.aliyun.com/scratchCardSlide/dataReport.jsonp"), a = window;
      t.log = function(e, t) {
        var n, a, r = t || o, c = ["a", "t", "scene", "ns", "jsv", "usa", "p", "jsType", "os", "em", "ec"], s = [],
          l = c.length;
        for (n = 0; n < l; n++) a = c[n], e.hasOwnProperty(a) && s.push(a + "=" + encodeURIComponent(e[a]));
        s.push("r=" + Math.random()), i(r + "?" + s.join("&"));
      };
    }, function(e, t, n) {
      "use strict";
      var i = n(1), o = { log: "//log.mmstat.com/", gm: "//gm.mmstat.com/", gj: "//gj.mmstat.com/" };
      t.mmstat_base = o;
      var a = i.isIEX(8), r = i.isIEX(7), c = i.isIEX(6), s = !!(c || r || a),
      ...
      o.getImgSize = function(e, t) {
        ...
        for (var n = [], i = 0, o = e.length; i < o; i++) n.push(t(e[i], i));
        return n;
        ...
        if ("function" == typeof e.fill) e.fill(t); else for (var n = 0, i = e.length; n < i; n++) e[n] = t;
        return e;
      }, e.exports = o;
    }, function(e, t, n) {
      "use strict";
      ...
      var s, l, d = "javascript:noCaptcha.reset()", u = "http://survey.taobao.com/survey/QgzQDdDd?token=%TOKEN",
        ...
        f = "https://survey.taobao.com/survey/AMnMVgrS4?type=%TYPE&str=%STR", g = "{0}", h = {
          ...
          }, i(s, "_ggk_action_timeout", ["You've been idled for too long<br/>Please", d, "try again", "or", f, "report your problem"]), i(s, "_ggk_fail", ["Oops, the chickens ran away<br/>Please", d, "try again", "or", f, "report your problem"]), i(s, "_ggk_success", "Congratulations! You've got the chickens!"), s)
        };
      ...
      function i(e) {
        for (var t = [], n = {}, i = 0; i < e.length; i++) {
          var o = e[i], a = o[0], r = o[1], c = o[2], s = o[3], l = { css: r, media: c, sourceMap: s };
      ...
      !function() {
        var n = {
          ...
          ASYNC: "async",
          create: function(e, t) {
            var i = "string" == typeof e.initial ? { state: e.initial } : e.initial, o = e.terminal || e["final"],
              a = t || e.target || {}, r = e.events || [], c = e.callbacks || {}, s = {}, l = {}, d = function(e) {
            ...
            i && (i.event = i.event || "startup", d({ name: i.event, from: "none", to: i.state }));
          ...
          leaveState: function(e, t, i, o, a) {
            var r = n.leaveThisState(e, t, i, o, a), c = n.leaveAnyState(e, t, i, o, a);
          ...
          buildEvent: function(e, t) {
            return function() {
              var i = this.current, o = t[i] || (t[n.WILDCARD] != n.WILDCARD ? t[n.WILDCARD] : i) || i,
      ...
      function i(e) {
        ...
        if (_.navigator.cookieEnabled && !n) {
          ...
          if (a != -1) {
            ...
            r == -1 && (r = f.cookie.length), t = decodeURIComponent(f.cookie.substring(a, r)) || "", n = t;
          }
        }
        return n;
      }
      ...
      function o(e, t, n) {
        n = n || 7;
        var i = new Date;
        i.setTime(i.getTime() + 864e5 * n), f.cookie = [encodeURIComponent(e), "=", encodeURIComponent("" + t), ";expires=", i.toGMTString()].join("");
      }
      ...
      function a() {
        ...
        return e = e || i(g), e || (e = h + r(11), o(g, e, 3650)), e;
      }
      ...
      function i(e, t) {
        this.id = function(e) {
          ...
          var i, o;
          if (t instanceof Array) for (i = 0, o = t.length; i < o; i++) this.extend(e, t[i], n);
          ...
          var l = setTimeout(function() {
            o.onerror("timeout");
          }, 2e4), d = r.getElementsByTagName("script")[0];
          ...
          var c = ("jsonp_" + Math.random()).replace(".", ""), s = r.getElementsByTagName("script")[0], l = "";
      ...
      function i(e, t) {
        var n, i, a = t ? {} : e;
        for (n in e) e.hasOwnProperty(n) && (i = e[n], "string" == typeof i && (i = [i]), a[n] = "<span class=\"nc-lang-cnt\" data-nc-lang=\"" + n + "\">" + o(p[n], i) + "</span>");
        return a;
      }
      ...
      var s, l = "javascript:noCaptcha.reset()", d = "https://survey.taobao.com/survey/AMnMVgrS4?type=%TYPE&str=%STR",
        u = "{0}", p = {
          _ggk_guide: "{0}",
          _ggk_start: u,
          _ggk_net_err: "{0}<a href=\"{1}\">{2}</a>{3}<a target=\"_blank\" href=\"{4}\">{5}</a>",
      ...
      for (s in _) _.hasOwnProperty(s) && i(_[s]);
      ...
      var i = n(25);
      "string" == typeof i && (i = [[e.i, i, ""]]), n(10)(i, {}), i.locals && (e.exports = i.locals);
    }, , , , , , , , , , , , , , , , , , , , , , , function(e, t, n) {
      "use strict";
      var i = window, o = n(1);
      t.makeLog = function(e) {
        function t(e, t, n) {
          var i = o.obj2param({ appkey: encodeURIComponent(e), token: encodeURIComponent(t), flag: n });
          o.send(a + "?cache=" + Math.random() + "&gmkey=evt&gokey=" + encodeURIComponent(i));
        }

        function n(t) {
          i.console && void 0;
          var n = e + "jstracker.2", a = o.obj2param({
            type: "9",
            id: "jstracker",
            v: "1",
            nick: "",
      ...
      var i = n(5), o = n(23);
      t.init = function(e) {
        var t = e.fsm, n = i.mix({}, o.default_options, e.options || {});
      ...
      "use strict";
      var i = n(127), o = n(128), a = n(126), r = n(5), c = a.names, s = n(2);
      t.init = function(e) {
        var t = e.fsm;
      ...
      Object.getPrototypeOf || (Object.getPrototypeOf = function(e) {
        ...
        for (var o = i >= 0 ? Math.min(i, n - 1) : n - Math.abs(i); o >= 0; o--) if (o in t && t[o] === e) return o;
        return -1;
        ...
        var i, o = arguments[1];
        for (i = 0; i < n; i++) if (i in t && !e.call(o, t[i], i, t)) return !1;
        return !0;
        ...
        if ("function" != typeof e) throw TypeError();
        var i, o = arguments[1];
        for (i = 0; i < n; i++) if (i in t && e.call(o, t[i], i, t)) return !0;
        return !1;
        ...
        if ("function" != typeof e) throw TypeError();
        var i, o = arguments[1];
        for (i = 0; i < n; i++) i in t && e.call(o, t[i], i, t);
        ...
        i.length = n;
        var o, a = arguments[1];
        for (o = 0; o < n; o++) o in t && (i[o] = e.call(a, t[o], o, t));
        return i;
        ...
        for (; o < n;) o in t && (i = e.call(void 0, i, t[o], o, t)), o++;
        return i;
      ...
      try {
        for (i = 0; i < c; i++) o = r[i], o.href && o.href.indexOf(a) != -1 && (o.disabled = !0);
      } catch (s) {
      }
    }, function(e, t, n) {
      "use strict";
      ...
      t.makeNC = function(e, t) {
        ...
        var c = {}, s = n(113).makeNC(e, t, c), l = n(120).NC2, d = [];
      ...
      function i(e, t, n) {
        var i = void 0, o = a.createElement("script");
        o.src = e;
        var c = void 0;
        o.onreadystatechange = function() {
          var e = o.readyState;
      ...
      !function(e) {
        ...
        if (!e[t]) {
          ...
          var o = e.pointman && "19" == pointman._z, a = {}, r = { has_pointman: o, index: 0, js_type: "pc", v: i };
          e.UA_Opt = e.UA_Opt || {};
          var c = n(74).makeNC(a, r);
          c.v = i, a.init = function() {
          }, r.has_pointman && (a.noCaptcha = c, pointman.define("nc", function() {
            return a;
          })), e.noCaptcha = c;
        }
      }(window);
      ...
      function i(e, t, n) {
        var i = e.prefix, r = 1, u = navigator && navigator.userAgent || "", p = /Firefox\/([\d.]*)/.test(u),
          _ = u.indexOf("Windows") !== -1, f = (new Date).getTime(), g = (new Date).getTime(),
          h = a.head || a.getElementsByTagName("head")[0] || a.documentElement, m = function(e) {
        ...
        return k.prototype = {
          render: function() {
            ...
            var r = this, s = r.tipText, l = r.config, d = a.createElement("div"), u = l.element;
            ...
            var _ = t.id(i + "_voice_close"), f = this;
            ...
            var e = 7, t = m(i + "wrapper").offsetWidth, n = m(i + "omeo-refresh-audio").offsetWidth,
              o = m(i + "_voice_close").offsetWidth, a = m(i + "omeo-code-key").offsetWidth, r = t - n - o - a - e;
            ...
            e.className = "omeo-code-state", e.innerHTML = "", o.__progtid && clearInterval(o.__progtid), m(i + "omeo-code-key").value = "", this.resetPlayer({ state: "playing" }), this.playAudio(), f = g = (new Date).getTime();
          }, switchCode: function(e) {
            "img" == e.type ? (this.stopAudio(), m(i + "omeo-code").className = "omeo-code omeo-img-active") : (m(i + "omeo-code").className = "omeo-code omeo-audio-active", this.resetPlayer({ state: "playing" }), !this.audioSupport || p || (m(i + "omeo-refresh-audio").style.display = ""), this.playAudio()), this.cache.checkState = "notstart", this.cache.checkedCode = null;
            var t;
            t = m(i + "omeo-code-state"), t.className = "omeo-code-state", t.innerHTML = "", t = m(i + "omeo-code-key"), t.value = "", t.focus(), this.cache.oldCode && this.refreshCode(), f = g = (new Date).getTime();
            ...
            function t(t) {
              ...
              var c;
              if (this.audioSupport) this.cache.audio = new Audio, c = a.createElement("source"), c.type = n, c.src = e, this.cache.audio.appendChild(c), this.cache.audio.load(), this.cache.audio.play(), this.bindAudioProgress(); else if (this.isIE) {
                var s = a.createElement("bgsound");
                s.setAttribute("id", "omeo-bgsound-audio" + r), s.setAttribute("autostart", "true"), s.setAttribute("src", e), h.appendChild(s), this.cache.audioPlayer = m(i + "omeo-bgsound-audio" + r), this.resetPlayer({ state: "playing" });
                var l = 0, d = this;
            ...
            if (n.stopAudio(), e) t.call(n); else {
              var c = y.then(function() {
                ...
                var i = { url: e, callback: "callback", data: {} };
            ...
            var n = this, a = m(i + "omeo-code-state"), c = "omeocode" + r + (+new Date).toString().substr(-6, 6),
            ...
            if (n.cache.checkState = "checking", /^[a-z0-9]{4,6}$/gi.test(e.code)) {
              ...
              s += "&" + d.obj2param(l), o[c] = function(t) {
                ...
                if (t.success && 100 == t.result.code) {
                  n.cache.checkedCode = e.code, a.className = "omeo-code-state omeo-code-state-success", a.innerHTML = "", n.cache.checkState = "success", o = { message: "success" };
                  var r = (new Date).getTime();
                  n.log({ t1: r - g, t2: r - f, s: t && "SUCCESS." === t.message, t: n.cache.codeType });
                ...
                }, 3e3), n.cache.checkState = "codeError", o = { message: "error" }, m(i + "omeo-code-key").select(), "true" == t.refresh && n.refreshCode();
              ...
              var e = m(i + "omeo-code-state");
              e && (e.className = "", e.innerHTML = "", e = m(i + "omeo-code-key"), e.value = "", e.focus(), n.resetPlayer({ state: "playing" }), n.playAudio());
            }, 5e3);
          }, check: function(e) {
      ...
      var o = window, a = document, r = n(9), c = r.names, s = n(2), l = n(112).language, d = n(1);
      n(21), t.init = i;
    }, function(e, t, n) {
      "use strict";
      ...
      function i() {
        ...
        var t = r.getElementsByTagName("script"), n = t[t.length - 1];
      ...
      function a(e) {
        ...
        var n = r.getElementsByTagName("script"), i = n[n.length - 1];
        i.parentNode.insertBefore(t, i);
      }

      var r = document;
      e.exports = { createSheet: i, addCSSRule: o, insertCSS: a };
    }, function(e, t, n) {
      "use strict";
      ...
      var s = window, l = document, d = l.documentElement, u = function() {
        }, p = n(2), _ = n(1), f = n(4).URL_MAP, g = n(7).language, h = _.isIEX(8), m = new p(function(e, t) {
      ...
      _.each(w, function(e, t) {
        ...
        init: function() {
          ...
          var e = this.options.$wrapper, t = e.offsetWidth, n = _.getElementLeft(e), i = _.getElementTop(e),
            o = this.$container.offsetWidth, a = s.innerWidth || d && d.clientWidth || l.body.clientWidth, r = "";
          a - t - n > o ? (r = "right", this.$container.style.left = (t - 150) / 2 + 108 + 30 + "px") : n > o && (r = "left", this.$container.style.left = -(o + 25 - (t - 150) / 2) + "px"), i < 339 && (this.$container.style.top = -i + 5 + "px"), r && _.addClass(this.$container, T + "-" + r);
          ...
          var a = this.klass("selected"), r = a.length;
          0 === r ? _.addClass(this.$confirm, T + "-disabled") : _.removeClass(this.$confirm, T + "-disabled"), c(this.$tip);
        }, confirm: function() {
          ...
          for (var n = "", i = 0; i < 9; i++) n += "<a href=\"javascript:void(0);\" class=\"" + T + "-item\" data-action=\"select\" data-i=\"" + i + "\"><i class=\"nc_iconfont\">" + x + "</i></a>";
          ...
          var t = this.$body, n = this.language, i = "close";
      ...
      function a(e, t, n) {
        ...
        var o = "script", a = r.createElement(o);
        a.charset = "utf-8", a.src = c;
        var s = r.getElementsByTagName(o)[0];
        s.parentNode.insertBefore(a, s);
      }

      var r = document, c = "//g.alicdn.com/sd/ncpc/lang-ex.js?t=" + Math.floor((new Date).getTime() / 846e5), s = n(1);
      t.loadExLang = a;
    }, function(e, t, n) {
      "use strict";
      var i = {
      ...
      "use strict";
      var i = n(114), o = n(116).makeScale, a = n(9), r = n(1), c = n(21).BaseFun, s = n(4).mmstat_base;
      t.makeNC = function(e, t, l) {
        function d(e, i, a, c) {
          var l = n(49).makeLog(i.foreign ? s.gj : s.gm), d = i.glog;
          ...
          var u = function(e) {
            ...
            if (n && n.length) {
              ...
              for (o = 0; o < n.length; o++) if (n[o].apply(null, r) === !1) return !1;
            }
          };
        ...
        function u(o) {
          o = r.mix(r.clone(g), o), t.index++, t.prefix = o.prefix || "nc_" + t.index + "_", n(115).reg(o);
          var a = {}, s = {}, l = new c(o, r.obj2param), u = d(t.index, o, a, l), p = u[0], _ = u[1],
            f = i.makeNoCaptcha(e, s, t, a, p, _, l), h = new f;
      ...
      function makeNoCaptcha(module_nc, opt, inn_vars, nc_events, Scale, onNCEvent, _) {
        ...
        var nc_index = inn_vars.index, nc_prefix = inn_vars.prefix, scale_btn = nc_prefix + "n1z",
          ...
          glog = __webpack_require__(49).makeLog(opt.foreign ? mmstat_base.gj : mmstat_base.gm), report = glog.report,
        ...
        return NoCaptcha.prototype = {
          init: function(e) {
            ...
            var n = window.console, i = event_deprecated[e];
            ...
            var e = ("initializeJsonp_" + Math.random()).replace(".", ""),
              ...
              n = document.createElement("script"), i = document.getElementsByTagName("script")[0];
            i.parentNode.insertBefore(n, i), window[e] = function(e) {
            }, n.src = t;
            ...
            var i = util.isIEX(6), o = util.isIEX(7), a = i || o ? " !important" : "";
            ...
            var i = _.id(e + "omeo-refresh-audio").offsetWidth, o = _.id(e + "_voice_close").offsetWidth,
              a = _.id(e + "omeo-code-key").offsetWidth, r = t - i - o - a - n;
            ...
            this.initUaParam();
            var e = this;
            UA_Opt.Token = (new Date).getTime() + ":" + opt.token, _.loadjs(util.addHourStamp(ajaxURL.uab_Url), function(t) {
            ...
            _.loadjs(ajaxURL.umid_Url, function(t) {
              if ("timeout" === t) showError(!0, ERR_CODE_UMTIMEOUT), reportLoadJSError(LOAD_JS_TIMEOUT, "um.js timeout"); else {
                try {
                  ...
                  var n = document.getElementById("_umfp"), i = (new Date).getTime();
                  umx.init({
                    timeout: opt.timeout,
                    timestamp: i,
                    token: opt.token,
            ...
            _.addHandler(t, "keydown", function i(e) {
              ...
              function i(t) {
                function i(e) {
                  if (e.success) if (100 == e.result.code) n.userCallback(objCheckCode.config.sessionid, e.result.value, e.result.sig); else if (900 == e.result.code) {
                    ...
                    var t = _.id(nc_prefix + "_captcha_text"), i = language[opt.language]._errorClickTEXT;
              ...
              e = !0, o.style.display = "block", objCheckCode && (objCheckCode.resetPlayer({ state: "end" }), objCheckCode.switchCode({ type: "audio" }));
              var a, r = 0;
              setTimeout(function() {
                a = !0;
              }, 3e3);
            ...
            var t = _.id(scale_bar), n = this, i = t.getElementsByTagName("span"), o = t.getElementsByTagName("div");
            ...
            if (e.success) {
              var n = e.result, i = n.code;
              if (0 === i) _.id(scale_btn).className = "nc_iconfont btn_ok", _.id(scale_btn).innerHTML = icon_ok_sign, TEXTELEM.innerHTML = language[opt.language]._yesTEXT, util.removeClass(t.btn.parentNode, "nc_err"), this.userCallback(n.csessionid, "pass", n.value); else if (UA_Opt.reload && (UA_Opt.Token = (new Date).getTime() + ":" + opt.token, UA_Opt.reload && UA_Opt.reload()), util.addClass(t.btn, "nc_iconfont btn_warn"), util.addClass(t.btn.parentNode, "nc_err"), t.btn.innerHTML = icon_warn, t.bar = _.tag(scale_bar + " div")[0], TEXTELEM.innerHTML = language[opt.language]._Loading + loading_circle_html, "function" == typeof opt.verifycallback && 300 != i && opt.verifycallback(n), 100 == i) this.__inn = 1, this.onScale100(n.csessionid, n.value); else if (200 == i) this.__inn = 1, this.onScale200(n.csessionid, n.value); else if (260 == i) this.onScale260(n.csessionid, n.value); else if (300 == i || 69634 == i) {
                var o = function(e, t, n) {
                  for (var i = 0, o = t, a = e.length; o < a;) i <<= 3, i += e.charCodeAt(o), o += n;
                  i < 0 && (i = 0 - i);
                ...
                report("block"), util.removeClass(inn_vars.TEXTELEM, "nc-align-center"), _.id(opt.renderTo).innerHTML = "<div class=\"errloading\"><i class=\"nc_iconfont icon_warn\">" + icon_warn + "</i>" + _upResetIndex(language[opt.language]._error300) + "(error:" + o(opt.token, 0, 1) + ")</div>", onNCEvent(event_names.error), onNCEvent(event_names.error300);
              }
            } else this.errorCallback();
          }, onScale100: function e(t, n, i) {
            var o = e, a = i || this, r = this, c = _.tag(nc_prefix + "clickCaptcha div");
              ...
              _.jsonp({
                ...
                success: function(e) {
                  if (e.result.question && (e.result.question = e.result.question.replace(/<span[^>]+?>/g, "<i>"), e.result.question = e.result.question.replace(/<\/span[^>]*?>/g, "</i>"), a.captchaToken = e.result.captchaToken), s = !0, l != -1) {
                    ...
                    var d = opt.appkey + "&sessionid", u = e.result.question.split(e.result.tags[0]), p = u.shift();
                    ...
                    _.addHandler(g, "click", function(e) {
                      util.addClass(inn_vars.TEXTELEM, "nc-align-center"), TEXTELEM.innerHTML = language[opt.language]._Loading + loading_circle_html, _.jsonp({
                        url: ajaxURL.checkcode, callback: "callback", data: {
                          csessionid: t,
                          checkcode: function() {
                            var t = {};
                            return t.imgid = d, t.w = g.width.toString(), t.h = g.height.toString(), t.x = void 0 === e.offsetX ? util.getOffset(e).offsetX : e.offsetX, t.y = void 0 === e.offsetY ? util.getOffset(e).offsetY : e.offsetY, t.x = parseInt(t.x).toString(), t.y = parseInt(t.y).toString(), t.captchaToken = a.captchaToken, _.obj2str(t);
                          }(),
                          a: opt.appkey,
                          t: opt.token,
                          ...
                          if (e.success) if (100 == e.result.code) i.className = "nc_iconfont btn_ok", i.innerHTML = icon_ok_sign, util.addClass(inn_vars.TEXTELEM, "nc-align-center"), _.tag(scale_bar + " div")[0].className = "nc_bg", TEXTELEM.innerHTML = language[opt.language]._yesTEXT, util.removeClass(i.parentNode, "nc_err"), _.toggle(nc_prefix + "clickCaptcha"), el_render_to && util.removeClass(el_render_to, "show-click-captcha"), a.userCallback && a.userCallback(t, n, e.result.sig); else if (900 == e.result.code) {
                            ...
                            var r = _.id(nc_prefix + "_captcha_text"), c = language[opt.language]._errorClickTEXT;
                          ...
                          } else 300 != e.result.code && 69634 != e.result.code || (report("block"), _.id(opt.renderTo).innerHTML = "<div class=\"errloading\"><i class=\"nc_iconfont icon_warn\">" + icon_warn + "</i>" + _upResetIndex(language[opt.language]._error300) + "</div>", onNCEvent(event_names.error), onNCEvent(event_names.error300)); else a.errorCallback();
                        }, fail: function(e) {
                          a.errorCallback(e);
                        }
                      });
              ...
              if (t) {
                ...
                _.jsonp({
                  url: ajaxURL.checkcode, callback: "callback", data: {
                    ...
                    if (t.success) {
                      var i = _.id(scale_btn), o = _.tag(nc_prefix + "imgCaptcha div")[2];
                      if (100 == t.result.code) i.className = "nc_iconfont btn_ok", i.innerHTML = icon_ok_sign, _.tag(scale_bar + " div")[0].className = "nc_bg", TEXTELEM.innerHTML = language[opt.language]._yesTEXT, util.addClass(inn_vars.TEXTELEM, "nc-align-center"), util.removeClass(i.parentNode, "nc_err"), o.style.borderTopColor = "#e5e5e5", _.toggle(nc_prefix + "imgCaptcha"), s.userCallback.call(this, e, n, t.result.sig); else if (900 == t.result.code) {
                        ...
                        a && (a.value = ""), UA_Opt.reload && UA_Opt.reload(), c.call(s, e, n);
                        ...
                        l.innerHTML = "<i class=\"nc_iconfont icon_close\">" + icon_close + "</i>" + r, l.style.display = "block", l.style.visibility = "visible", o.style.borderTopColor = "red";
            ...
            var a = this, r = _.id(nc_prefix + "imgCaptcha");
            r && (this.__is_c_width_setted || this.updateWidth(_.id(nc_prefix + "wrapper"), 1));
            var c = t, s = this, l = _.tag(nc_prefix + "imgCaptcha div"), d = supportDataURI.then(function() {
              return ajaxURL.get_img;
            }, function() {
              return ajaxURL.get_img_pre;
            }).then(function(t) {
              var i = opt;
              return util.request({ url: t, data: { sessionid: e, identity: i.appkey, token: opt.token, style: n } });
            }).then(function(e) {
              ...
              r.style.display = "block", l[1].innerHTML = "", l[1].appendChild(t);
            ...
            var i = { csessionid: e || null, value: t || null, sig: n || null, token: _getToken() };
            ...
            if (util.getElementsByClassName("nc-required-js-" + nc_index), e = i.length, e > 0) for (t = 0; t < e; t++) n = i[0].parentNode, n && n.removeChild(i[0]);
          }
        }, NoCaptcha;
      }
      ...
      var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(e) {
          ...
          return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e;
        }, win = window, doc = document, tb_login, util = __webpack_require__(1),
        ImgCategoryCaptcha = __webpack_require__(110), mmstat_base = __webpack_require__(4).mmstat_base,
        URL_MAP = __webpack_require__(4).URL_MAP, language = __webpack_require__(7).language,
        _upLang = __webpack_require__(7).upLang, upResetIndex = __webpack_require__(7).upResetIndex,
        loadExLang = __webpack_require__(111).loadExLang, makeTemplate = __webpack_require__(119).makeTemplate,
        m_checkcode = __webpack_require__(108), makeShowHelp = __webpack_require__(117).makeShowHelp,
        default_opt = __webpack_require__(22).default_opt, report2 = __webpack_require__(3),
        css = __webpack_require__(109), MAX_ERR_TIME = 3,
        NC_LOGO_URL = "//img.alicdn.com/tfs/TB1itI1PVXXXXXTXVXXXXXXXXXX-52-32.png", ERR_CODE_ANALYZETIMEOUT = "00",
        ERR_CODE_UABTIMEOUT = "01", ERR_CODE_UMTIMEOUT = "02", ERR_CODE_UMXUNDEFINED = "04",
        ERR_CODE_UMXRETRYLIMIT = "08", ERR_CODE_CAPTCHA_NOTAG = "16", ERR_CODE_IMAGE_TIMEOUT = "32",
        ERR_CODE_IMAGE_REQUEST_ERROR = "64", LOAD_JS_TIMEOUT = "LOAD_JS_TIMEOUT", icon_warn = "&#xe60a;",
        icon_ok_sign = "&#xe60b;", icon_close = "&#xe609;", m_event = __webpack_require__(9),
        event_names = m_event.names, event_deprecated = m_event.deprecated, Promise = __webpack_require__(2);
      ...
      function o(e, t, n) {
        ...
        return o.prototype = {
          init: function(t) {
            function i(i) {
              function a() {
                s.btn.onmousedown = null, s.txt.onmousedown = null, e.removeEvt(l, "mousemove", r), e.removeEvt(l, "mouseup", f), e.removeEvt(l, "touchmove", h), e.removeEvt(l, "touchend", g), e.removeEvt(s.btn, "touchstart", o), e.removeEvt(s.txt, "touchstart", o);
                var i = {};
              ...
              function r(e) {
                ...
                var t = (e || p.event).clientX, i = _.min(y, _.max(-2, k + (t - v)));
                s.btn.style.left = i + "px", s.ondrag(_.round(100 * _.max(0, i / y)), i);
                var o = x + s.bar.offsetWidth;
                if (t >= o && (i < y || t - k < y)) return void f.call(this);
              ...
              var m = !1, v = (i || p.event).clientX, b = s.btn.offsetWidth, y = s.bar.offsetWidth - b,
                k = s.btn.offsetLeft, x = c.getClientRect(s.bar).left;
              e.addHandler(l, "mousemove", r), e.addHandler(l, "mouseup", f), e.addHandler(l, "touchmove", h), e.addHandler(l, "touchend", g);
            }
      ...
      var a = window, r = document, c = n(1), s = n(7).language, l = n(22).default_opt, d = n(9).names;
      t.makeScale = o;
    }, function(e, t, n) {
      "use strict";
      ...
      function i(e, t, n) {
        ...
        function r() {
          ...
          function i() {
            function n() {
              var t = 0, n = 260, i = setInterval(function() {
            ...
            var i = t.id(e.renderTo), r = i.getBoundingClientRect(), s = r.left, l = r.top + 20 + o.body.scrollTop;
          ...
          return _.innerHTML = a[e.language]._closeHelp, _.onclick = function() {
      ...
      function i(e) {
        ...
        function a(e, t) {
          ...
          for (n = 0; n < a.length; n++) if (i = a[n], o = i.className, o && o.indexOf(t) > -1) return i;
          return null;
        }

        function r(e) {
          var n = t(g + "_scale_text"), i = a(e, "captcha-error");
        ...
        function d(e) {
          if (f) {
            ...
            var o = f.className || "", a = "tb-login";
            o.indexOf(a) == -1 && (f.className = (o + " " + a).replace(/^\s+|\s+$/g, "")), f.className.match(/\bnc-old-login\b/) && (p = !0);
            var r;
            if (r = t("J_LoginBox") || t("J_Login") || h.getElementsByClassName("nc-outer-box")[0]) {
              var c = p ? 0 : 2, u = i(f), _ = d;
              if (u <= 0) {
              ...
              var x, w;
              w = t(g + "imgCaptcha"),
              w && (w.style.top = y + c + "px", x = v - c - 66, b && (x -= 13), b || 0 !== s() || (w.style.minHeight = "290px", x -= 10), w.style.height = x + "px", b && (w.style.minHeight = 0)), w = t(g + "clickCaptcha"), w && (w.style.top = y + c + "px", p ? (l(), x = v + 30, x < 255 && (x = 255), w.style.height = x + "px") : (l(), x = v - c - 30, b && (x -= 8), w.style.height = x + "px"), b && (w.style.minHeight = 0));
            }
          }
        }
        ...
        return { init: u, adjustPosition: d, getInform: r };
      }
      ...
      var o = function() {
        ...
        }(), a = n(13), r = n(17), c = n(5), s = n(125).default_opt, l = n(3), d = n(2),
        u = [{ name: "init", from: "initially", to: "loading" }, {
          ...
          return o(e, [{
            key: "makeFSM", value: function() {
              var e = this;
              this.fsm = a.create({ initial: "initially", events: u }), this.fsm.onenterstate = function(t, n, i) {
                if ("loading" !== i) {
      ...
      var _slicedToArray = function() {
        ...
        }(), html = __webpack_require__(124).html, kvTpl = __webpack_require__(19), BaseFn = __webpack_require__(121),
        util = __webpack_require__(5), cfg = __webpack_require__(23), URL_MAP = __webpack_require__(68).URL_MAP,
        language = __webpack_require__(24).language, replaceLang = __webpack_require__(24).replaceLang,
        upResetIndex = __webpack_require__(24).upResetIndex, Promise = __webpack_require__(2),
        Report = __webpack_require__(3), doc = document, getElementById = function(e) {
          return doc.getElementById(e);
        }, styleEl = function(e, t, n) {
          return e.style[t] = n;
        }, ERR_CODE_API_FAIL = "SCRAPE_API_FAIL", FAIL_PREPARE = "fail_prepare", FAIL_ANALYZE = "fail_analyze",
        win = window;
      __webpack_require__(26), __webpack_require__(133);
      var obj_w = -1, obj_h = -1, Scrape = function() {
        ...
        return _createClass(Scrape, [{
          ...
          key: "loading_sendInitReq", value: function() {
            var e = this;
            return new Promise(function(t, n) {
              var i = e.options, o = e.getParamOl(),
              ...
              e.baseFn.jsonp({
                ...
                success: function(i) {
                  ...
                  a.style.display = "block", a.innerHTML = e._lang._ggk_start, e.showHow(), e.scrapeStart = !1, util.addClass(e.root, "nc-prepared"), util.removeClass(e.root, "nc-state-load-error");
                  var r = (e.nc.index > 0 ? e.nc.index : 1, e.getEl("container"));
          ...
          key: "putObjects", value: function() {
            var e = this, t = this.svr_data, n = t.objectPoints, i = n.points;
            ...
            o.innerHTML = util.map(i, function(t, n) {
              var i = t.x, o = t.y, a = i - e.obj_w / 2, r = o - e.obj_h / 2, c = e.options.elements,
                s = c[n % c.length];
          ...
          key: "render_surface_dg", value: function() {
            var e = this, t = this.getEl("canvas-dg"), n = this.size.width, i = this.size.height;
            t.style.width = n + "px", t.style.height = i + "px", t.style.display = "block";
            for (var o = cfg.grid_size, a = Math.ceil(n / o), r = Math.ceil(i / o), c = [], s = this.options.bg_back, l = 0; l < r; l++) for (var d = 0; d < a; d++) {
              var u = o * l, p = o * d, _ = {
                  width: o + "px",
                  height: o + "px",
                  top: u + "px",
          ...
          key: "render_surface", value: function() {
            ...
            var t = this.el_canvas, n = this.ctx, i = this.size;
            ...
            l.src = this.options.bg_front, l.onload = function() {
              ...
              for (var e = l.naturalWidth ? [l.naturalWidth, l.naturalHeight] : [l.width, l.height], t = _slicedToArray(e, 2), o = t[0], a = t[1], r = Math.ceil(i.width / o), c = Math.ceil(i.height / a), s = 0; s < c; s++) for (var d = 0; d < r; d++) n.drawImage(l, d * o, s * a);
          ...
          key: "getPos", value: function(e) {
            var t = (doc.documentElement.scrollLeft || doc.body.scrollLeft, doc.documentElement.scrollTop || doc.body.scrollTop, this.options.renderTo),
              n = getElementById(0 === t.indexOf("#") ? t.slice(1) : t), i = 0, o = 0;
            "absolute" == n.style.position && (i = n.offsetLeft, o = n.offsetTop);
            var a = this.getEl("nc-canvas"), r = e.clientX - a.getBoundingClientRect().left,
              c = e.clientY - a.getBoundingClientRect().top;
            return [r, c];
          }
        }, {
          key: "_clearTo_dg", value: function(e, t) {
            var n = Math.floor(e / cfg.grid_size), i = Math.floor(t / cfg.grid_size), o = this.mkGridId(n, i),
          ...
          key: "_calcRegion", value: function(e, t, n, i) {
            for (var o = this.ctx.getImageData(e, t, n, i).data, a = 0, r = 0; r < o.length; r += 4) o[r] && o[r + 1] && o[r + 2] && o[r + 3] && a++;
            return 1 - a / n / i;
          }
        }, {
          key: "_calcRegion_dg", value: function(e, t, n, i) {
            for (var o = cfg.grid_size, a = Math.floor(e / o), r = Math.floor(t / o), c = Math.floor(n / o), s = Math.floor(i / o), l = 0, d = r; d < r + s; d++) for (var u = a; u < a + c; u++) {
          ...
          key: "calc_dg", value: function() {
            var e = this, t = void 0, n = void 0, i = this.matrix.reduce(function(e, t) {
              return e + t;
            }, 0);
            t = 1 - i / this._grid_sum;
            var o = this.is_downgraded ? .7 : .9, a = this.obj_w / 2 * o, r = this.obj_h / 2 * o;
          ...
          key: "calc", value: function() {
            ...
            var t = this.size, n = t.width, i = t.height, o = this._calcRegion(0, 0, n, i), a = this.obj_w / 2,
              r = this.obj_h / 2, c = util.map(this._points, function(t) {
                var n = t.x, i = t.y;
          ...
          key: "_mkErrInfo", value: function(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : [],
              n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = this.options, o = e,
              a = [i.appkey, i.token, i.scene], r = "";
            switch (e) {
              case FAIL_PREPARE:
          ...
          key: "on_load_error", value: function(e) {
            ...
            return new Promise(function(e, n) {
              ...
              var i = function o() {
                var n = t.getEl("load-error"), i = void 0, a = t.getEl("cover");
          ...
          key: "eventDown", value: function(e) {
            ...
            if ("ready" == this.nc.fsm.current) {
              ...
              var n = this.getPos(e), i = _slicedToArray(n, 2), o = i[0], a = i[1];
          ...
          key: "eventMove", value: function(e) {
            ...
            if (this.mousedown) {
              ...
              var i = this.getPos(e), o = _slicedToArray(i, 2), a = o[0], r = o[1];
              this._clearTo(a, r);
          ...
          key: "mkMatrix", value: function() {
            var e = this.size, t = e.width, n = e.height, i = cfg.grid_size, o = Math.ceil(t / i), a = Math.ceil(n / i),
              r = o * a;
          ...
          key: "showHow", value: function() {
            if (!this.showingHow && !this.scrapeStart) {
              var e = this.getEl("show-how"),
                ...
                n = 2, i = 0, o = 0, a = t.length;
              e.style.display = "block", e.style.left = "0px";
              var r = this, c = function s() {
      ...
      function i(e, t, n) {
        ...
        var a = void 0, r = d[e.foreign] || d[0];
        r = l.mix(r, e.apimap), UA_Opt.LogVal = "_n", u.init(e), UA_Opt.sendMethod = 8, UA_Opt.Token = (new Date).getTime() + ":" + e.token, l.loadScript(l.addHourStamp(r.uab_Url), function(e) {
          if (AWSC) {
            var t = function() {
              if (window.__sc__uab) {
                if (clearInterval(n), "timeout" === window.__sc__uab) return void i(p);
                i(e);
              }
            };
      ...
      function a(e, t, n) {
        ...
        a = l.mix(a, e.apimap), l.loadScript(a.umid_Url, function(t) {
          ...
          var n = s.getElementById("_umfp"), o = (new Date).getTime();
          try {
            umx.init({
              timeout: e.timeout,
              timestamp: o,
      ...
      var c = window, s = document, l = n(5), d = n(68).URL_MAP, u = n(105), p = (n(3), "timeout"), _ = void 0;
      t.load = function(e, t) {
        var n = void 0, o = void 0, r = void 0, c = e.options, s = c.timeout || 1e4;
        i(c, function(i) {
          n = 1;
          var a = i == p;
